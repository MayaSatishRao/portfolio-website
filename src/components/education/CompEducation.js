                 ...
                 <p className="skill-text"><span style={{fontWeight:"bold",color:"black", marginRight:"0.3rem"}}>Backend Tech:</span>Django, Node.js</p>
                  ...
                  <div classname="profiles" style={{marginTop:"3rem"}}>
                     ...
                     <div className="profile-images">
                          ...
                          <div className="profile">
                              <div className="profile-image leetcode-image">
                          ...
                          <div className="profile">
                              <div className="profile-image gfg-image">
                                 <img src="https://cdn.iconscout.com/icon/free/png-256/code-forces-3521352-2944796.png?f=webp&w=128"/>
                              </div>
                              <a href="https://codeforces.com/profile/Maya25">Codeforces</a>
                          </div>
                     </div>
                  </div>
               </div>    
